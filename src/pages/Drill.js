...
import drillactivity from "../resources/images/drill_activity.jpg";
import drill2 from "../resources/images/drill2.jpg";
                      ...
                      <div className="max-w-xl text-center lg:text-left">
                        <div>
                          ...
                          <p className="max-w-xl text-lg mt-4  tracking-tight text-gray-600">
                            Drill is an important activity of a cadet's life. Turnout is very important in drill activity and it inculcates a sense of discipline, smartness in appearance, which creates self confidence. In addition to these, it brings the coordination between mind and body. Drill is the most efficient way of moving a number of people from one place to next. Drill is defined as being instructed in military excercises that includes marching, saluting and turning. Words of command is the order given during a drill. There are some important factors required for the word of command to be perfect are loudness, distinctness, inflection, snap, timing.
                          </p>
                        </div>
                  ...
                  <div className="relative flex-col items-center m-auto align-middle">
                    <div className="items-center gap-12 text-left lg:gap-24 flex flex-col-reverse lg:flex-row lg:inline-flex">
                      <div className="flex flex-col m-auto md:order-first">
                        ...
                        <div className=" lg:max-w-7xl mb-4">
                        <div>
                            <p className=" text-lg font-bold leading-6 text-blue-600">
                              Role of command in drill-
                            </p>
                          </div>
                          <div className="mt-2 text-base text-gray-500">
                            Commanding is the necessary part of drill. Proper execution of command depends on the tone and pitch of voice in which it is given. The command should be loud and should be clearly understood by each and every person
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className=" text-base text-gray-500">
                            a. SAVDHAN (Squad Attention) <br />
                            b. VISHRAM (Stand At Ease) <br />
                            c. ARAM SE (Stand Easy)<br />
                            d. DAHINE MUR or BAAYE MUR (Turning)<br />
                            e. PICHE MUR (About Turn)<br />
                            f. ADHA DAHINE OR ADHA BAAYE (Inclining)<br />
                            g. SALUTE<br />
                            h. DAHINE SALUTE OR BAAYE SALUTE<br />
                            i. DAHINE SAJ (Dressing)<br />
                            j. MARCHING<br />
                            k. FOOT MARCH DRILL<br />
                            l. Fall In Fall Out<br />
                          </div>
